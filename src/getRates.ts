...
RUB->GEL: 1GEL=${rates.koronaRateGEL.toFixed(2)}RUB ${
    bestRubToGelPlatform === 'KoronaPay' ? '👍' : ''
  }
RUB->USD: 1USD=${rates.koronaRateUSD.toFixed(2)}RUB ${
    bestRubToUsdPlatform === 'KoronaPay' ? '👍' : ''
  }
-------------------------
ByBit
...
RUB->USDT->GEL: 1GEL=${rubToGelInByBit.toFixed(2)}RUB ${
    bestRubToGelPlatform === 'ByBit' ? '👍' : ''
  }
RUB->USDT->USD: 1USD=${rubToUsdInByBit.toFixed(2)}RUB ${
    bestRubToUsdPlatform === 'ByBit' ? '👍' : ''
  }
-------------------------
